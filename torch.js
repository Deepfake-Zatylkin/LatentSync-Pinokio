  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": "pip install torch==2.2.2 torchvision==0.17.2 {{args && args.xformers ? 'xformers' : ''}} --index-url https://download.pytorch.org/whl/cu121 --extra-index-url https://download.pytorch.org/whl/cu121/xformers"
      }
    },
    // windows amd
    {
